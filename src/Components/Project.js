            ...
            <div class="row g-4 portfolio-container wow fadeInUp" data-wow-delay="0.1s">
                <div class="col-lg-4 col-md-6 portfolio-item first">
                    <div class="portfolio-img rounded overflow-hidden">
                        <img class="img-fluid" src={require('../Assets/img/project-6.jpg')} alt=""/>
                ...
                <div class="col-lg-4 col-md-6 portfolio-item second">
                    <div class="portfolio-img rounded overflow-hidden">
                        <img class="img-fluid" src={require('../Assets/img/project-1.jpg')} alt=""/>
                        <div class="portfolio-btn">
                ...
                <div class="col-lg-4 col-md-6 portfolio-item first">
                    <div class="portfolio-img rounded overflow-hidden">
                        <img class="img-fluid" src={require('../Assets/img/project-2.jpg')} alt=""/>
                        <div class="portfolio-btn">
                ...
                <div class="col-lg-4 col-md-6 portfolio-item second">
                    <div class="portfolio-img rounded overflow-hidden">
                        <img class="img-fluid" src={require('../Assets/img/project-3.jpg')} alt=""/>
                        <div class="portfolio-btn">
                ...
                <div class="col-lg-4 col-md-6 portfolio-item first">
                    <div class="portfolio-img rounded overflow-hidden">
                        <img class="img-fluid" src={require('../Assets/img/project-4.jpg')} alt=""/>
                        <div class="portfolio-btn">
                ...
                <div class="col-lg-4 col-md-6 portfolio-item second">
                    <div class="portfolio-img rounded overflow-hidden">
                        <img class="img-fluid" src={require('../Assets/img/project-5.jpg')} alt=""/>
                        <div class="portfolio-btn">
